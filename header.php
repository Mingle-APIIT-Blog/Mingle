...
<header class="header-1">
    <nav class="navbar navbar-expand-lg">
        <div class="container">
            <a class="navbar-brand" href="index.php"><img src="assets/images/BrandLogo.png" width="180px"
                    height="60px"></a>
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li
                        class="nav-item <?php echo basename($_SERVER['PHP_SELF']) == 'alumni_view.php' ? 'active' : ''; ?>">
                        <a class="nav-link" href="alumni_view.php">Alumni</a>
                    </li>
                    <?php if ($isLoggedIn): ?>
                    <li
                        class="nav-item <?php echo basename($_SERVER['PHP_SELF']) == 'calendar.php' ? 'active' : ''; ?>">
