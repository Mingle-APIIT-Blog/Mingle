...
// Retrieve alumni blog posts from the database
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="text-content">
                            <h4>APIIT Alumni Association</h4>
                            <a href="https://docs.google.com/forms/d/e/1FAIpQLSeXOgk5EkJZPhO2ojXrtLRtkikNXTVWgXVtEZDLF5L8PQ09nw/viewform?pli=1"
                            ...
                            <div class="col-lg-6">
                                <div class="blog-post">
                                    <div class="blog-thumb">
                                        ...
                                        <img src="data:image/jpeg;base64,<?php echo $post['blogImage']; ?>"
                                            height="250px" alt="Blog Image">
                                        <?php endif; ?>
                                    </div>
                                    <div class="down-content">
                                        ...
                                        <ul class="post-info">
                                            ...
                                            <li><a
                                                    href="#"><?php echo date('M d, Y', strtotime($post['creationDate'])); ?></a>
                                            </li>
                                        </ul>
                                        <?php
